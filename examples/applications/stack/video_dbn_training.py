...
if __name__ == '__main__':
    ...
    for j in range(1):
        ...
        model = SpecDBN(model=['gaussian'], n_visible=(dy, dx), n_hidden=(hidden, hidden, hidden), steps=(1,1,1),
        ...
        mse = model.fit(train, batch_size=batch_size, epochs=[ep, ep, ep])
